      ...
      <div className={styles.menuContainer}>
        <div className={styles.menuBox}>
          <div className={styles.menuContainerBox}>
            ...
            <a href="/"><p className={styles.menuItem}>PRODUCT LINE</p></a>
            <a href="/"><p className={styles.menuItem}>MACHINERY AND TOOLS</p></a>
            <a href="/"><p className={styles.menuItem}>CONTACT US</p></a>
          </div>
        </div>
      </div>
